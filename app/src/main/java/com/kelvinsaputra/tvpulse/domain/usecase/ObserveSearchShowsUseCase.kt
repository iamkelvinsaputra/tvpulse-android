...
class ObserveSearchShowsUseCase @Inject constructor(
    private val repository: TvShowRepository,
) {
    operator fun invoke(query: String, limit: Int): Flow<List<TvShow>> =
        repository.observeSearchShows(query, limit)
}
